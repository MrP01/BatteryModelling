...
\begin{tikzpicture}[scale=0.72]
  \begin{axis}[
    ...
    % box descriptions
    \draw (-1.5,0.5) node (inputs) {\Large \begin{tabular}{c} Current profile $I(t)$ \\ and/or power profile \end{tabular}};

    \node at (5.5,1.125) (voltout) {\Large $V(t)$};
    \node at (2,1.50) (ecmtext1) {\Large $V = V_{OC} -...$};
    \node at (2,1.15) (ecmtext2) {\Large $R_0,R_1,C_1$};
    \node at (5.5,-0.125) (sohout) {\Large $h(t)$};

    \node at (2,-0.50) (captext1) {\Large $Q_0 = Q_{00} - ...$};
