...
\begin{document}
  ...
  Also $F_{\rm current}(I)$ represents the \textit{Current Scaling Factor}, a value $0 < F_{\rm current} \leq 1$ that incorporates behaviour where higher currents are worse for cycle aging.
