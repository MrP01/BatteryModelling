...
\begin{document}
  ...
  \begin{abstract}
    \label{abstract}
    This work will attempt to devise a mathematical model for Lithium-Ion batteries (cf. \Cref{fig:model-overview}) and, building on it, one for electric vehicles (EVs).
