...
\begin{document}
  ...
  \begin{abstract}
    ...
    We implement the \gls{ev} model, which is a first-order system of \glstext{ode}s, using the system  solver functionality of MATLAB as well as a numerical forward integration scheme.
  ...
  For this purpose, we obtain graph data of the road network of choice (users may enter new localities as a text input) from \gls{osm} \parencite{osm}.
