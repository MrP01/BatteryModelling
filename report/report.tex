...
% TODO: check all figures - good captions?
% TODO: check all figures - are they referenced?
...
\begin{document}
  ...
  \begin{abstract}
    ...
    The first part of this report will focus on the model for the battery which was the focus of our project. The second part is the route optimisation problem in the context of electric vehicles.
    ...
    The model was implemented in Python and there is a graphical user interface available that provides live insight into the model (cf. \Cref{fig:user-interface}).
  \end{abstract}
  ...
  Our code used this scheme to solve the ODE system resulting from the equivalent cicuit model. More information on the code can be found in \Cref{sec:code}.
...
until convergence, repeat
  ...
  In this report, we introduced a battery model based on the Thevenin equivalent circuit model (\Cref{fig:ecm}) which we equipped with adaptive parameters based on real-world data from a Panasonic battery product.
