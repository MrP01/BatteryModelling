...
until convergence, repeat
  ...
  Finally, Type-4 was added to allow for much larger changes using a NetworkX subroutine yielding a simple path between two vertices which were neighbours in the previous route.
  ...
  Potential improvements are, for instance, using more analytical methods to obtain solutions of the variational optimisation problem described in \Cref{sec:problem}.
